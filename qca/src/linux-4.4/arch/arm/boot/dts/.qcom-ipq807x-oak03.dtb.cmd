cmd_arch/arm/boot/dts/qcom-ipq807x-oak03.dtb := mkdir -p arch/arm/boot/dts/ ; arm-openwrt-linux-uclibcgnueabi-gcc -E -Wp,-MD,arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.d.pre.tmp -nostdinc -I./arch/arm/boot/dts -I./arch/arm/boot/dts/include -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.dts.tmp arch/arm/boot/dts/qcom-ipq807x-oak03.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/qcom-ipq807x-oak03.dtb -b 0 -i arch/arm/boot/dts/  -d arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.d.dtc.tmp arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.dts.tmp ; cat arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.d.pre.tmp arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.d.dtc.tmp > arch/arm/boot/dts/.qcom-ipq807x-oak03.dtb.d

source_arch/arm/boot/dts/qcom-ipq807x-oak03.dtb := arch/arm/boot/dts/qcom-ipq807x-oak03.dts

deps_arch/arm/boot/dts/qcom-ipq807x-oak03.dtb := \
  arch/arm/boot/dts/../../../arm64/boot/dts/qcom/qcom-ipq807x-oak03.dts \
...
arch/arm/boot/dts/qcom-ipq807x-oak03.dtb: $(deps_arch/arm/boot/dts/qcom-ipq807x-oak03.dtb)
